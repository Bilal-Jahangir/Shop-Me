        ...
        <div className='container'>
            ...
            gap-6 items-center'>
                ...
                gap-6 sm:pt-0'>
                    ...
                    leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis quam dignissimos repellat illum mollitia, nesciunt recusandae similique itaque perferendis, maiores numquam rem tempore possimus culpa autem nisi ullam. Similique explicabo voluptatibus doloremque beatae optio libero esse ab laudantium obcaecati sapiente?</p>
                    <div className='flex flex-col gap-4'>
                        ...
                        <div data-aos='fade-up'
                        className='flex items-center gap-4'>
                            <GrInspect className='text-4xl h-12 w-12
                            shadow-sm p-4 rounded-full bg-orange-100
                            dark:bg-orange-400'/>
                            <p>Get Offers</p>
                        </div>
